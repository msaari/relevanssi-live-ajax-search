...
* New feature: New filter hook `relevanssi_live_search_result_arrow` filters the `&raquo;` arrow in the search results. Contributor: Marco Almeida.
...
== Upgrade Notice ==
= 2.6 =
* Security update to tighten privacy, new filter hooks.